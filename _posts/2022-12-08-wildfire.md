...
The dangers of wildland fires continues to grow due to climate change. Mere minutes can turn a previously safe situation into a near-death scenario, as shown in the video below. Firefighters need more expansive and timely situational awareness to operate safely in these chaotic environments.
...
Wildfires are obviously dangerous environments to test in. Therefore it's of utmost importance to validate as much as possible about any planning algorithms before deploying them in the field.
...
AirSim permits flexible API control through ROS. Unreal Engine provides high quality graphics, visualization, and powerful environment editing. GridFire is an open source scientific wildfire model, allowing one to import real-world landsat data of any location on earth, to simulate realistic growth of fires. Our Wildfire AirSim simulator combines the advantages of all these sources.
